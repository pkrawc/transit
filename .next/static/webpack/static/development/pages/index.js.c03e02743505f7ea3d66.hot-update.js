...
})(["position:relative;background:", ";margin-top:2rem;border-radius:2px;box-shadow:0 9px 0 -6px rgba(0,0,0,0.1);width:100%;input{all:unset;padding:1rem;font-size:1.5rem;box-sizing:border-box;display:block;width:calc(100% - 4reem);margin-left:4rem;}&::before{content:\"\";position:absolute;top:2rem;left:2rem;border:4px solid ", ";width:1rem;height:1rem;}.source{border-bottom:1px solid ", ";}"], _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].grey_100, _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].blue_300, _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].grey_300);

/***/ })

})
//# sourceMappingURL=index.js.c03e02743505f7ea3d66.hot-update.js.map