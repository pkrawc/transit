...
})(["position:relative;background:", ";margin-top:2rem;border-radius:2px;box-shadow:0 9px 0 -6px rgba(0,0,0,0.1);width:100%;padding:1rem 2rem;input{all:unset;font-size:1.5rem;box-sizing:border-box;display:block;width:calc(100% - 4rem);margin-left:4rem;padding-top:1rem;padding-bottom:1rem;}&::before{content:\"\";position:absolute;top:2.25rem;left:2.25rem;border:4px solid ", ";width:0.75rem;height:0.75rem;}&::after{content:\"\";position:absolute;bottom:2.25rem;left:2.25rem;border:4px solid ", ";width:0.75rem;height:0.75rem;border-radius:50%;}.source{border-bottom:1px solid ", ";}"], _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].grey_100, _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].blue_300, _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].blue_300, _constants_js__WEBPACK_IMPORTED_MODULE_2__["colors"].grey_300);

/***/ })

})
//# sourceMappingURL=index.js.8a0da2e1909e2171efd8.hot-update.js.map